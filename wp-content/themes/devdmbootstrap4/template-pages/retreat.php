...
<div class="row" style="margin-top:20px;">
    ...
    <div class="row">
        <div class="col-sm-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/retreat-daily.jpg"  class="img-rounded smsc_img_beginner"  alt="beginner">
        </div>
        <div class="col-sm-6">
            <div class="row" >
                    <div class="col">
            ...
            <div class="row" style="margin-top:20px;">
                    ...
                    <a href="<?php echo esc_url( get_permalink( get_page_by_title('dayretreat') ) ); ?>" class="btn btn-lg btn-outline">
                    Register</a> 
                    </div>
            </div>
        </div>
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="col-sm-6">
            ...
            <div class="row" style="margin-top:20px;">
                    <div class="col text-center">
                    <a href="<?php echo esc_url( get_permalink( get_page_by_title('monthlyretreat') ) ); ?>" class="btn btn-lg btn-outline">
                    Register</a> 
                    </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/retreat-monthly.jpg"  class="img-rounded smsc_img_beginner"  alt="beginner">
        </div>
    </div>
    ...
    <div class="row" style="margin-top:20px;">
        ...
        <div class="col-sm-6">
            ...
            <div class="row" style="margin-top:20px;">
                    <div class="col text-center">
                    <a href="<?php echo esc_url( get_permalink( get_page_by_title('annualretreat') ) ); ?>" class="btn btn-lg btn-outline">
                    Register</a> 
                    </div>
            </div>
        </div>
    ...
    <div class="row" style="margin-top:20px;" >
        <div class="col">
             ...
             <div class="row">
                <img class="col" style="width:350px;height:233px" src="<?php echo get_template_directory_uri(); ?>/images/classes-beginner.jpg"  
                 alt="Intermediate">
                 </div>
                <div class="row">
...
These classes are 2-hour long, involving several guided meditation periods and a lecture about the practice, with a Q and A period. 
        ...
        <div class="row">
        <div class="col text-center">
            <a href="<?php echo esc_url( get_permalink( get_page_by_title('intermediate') ) ); ?>" class="btn btn-lg btn-beginner">
            Register</a> 
            </div>
        ...
        <div class="row">
        <img class="col" style="width:350px;height:233px" src="<?php echo get_template_directory_uri(); ?>/images/events-02.jpg"  
         alt="Monthly Retreat">
         </div>
        <div class="row">
        <span class = "col label label_title_beginner" style="margin-top:10px;">
