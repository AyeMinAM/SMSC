        ...
        <div class="row">
                 <div class="col-lg-4 col-md-6 col-xs-12">
                  <div class="card card-smsc">
                    <div class="card-o-programs-img-bottom smsc_header_img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/classes-intermediate.jpg">
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                  <div class="card card-smsc">
                      <div class="card-o-programs-img-bottom smsc_header_img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/retreat-daily.jpg">
                        </div>
                        <div class="vertical-center">
                          <div class="card-block">
                            <h4 class="card-title">Daily Reteat</h4>
                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                  <div class="card card-smsc card-smsc-others-programs-last">
                       <div class="card-o-programs-img-bottom smsc_header_img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/retreat-monthly.jpg">
                       </div>
                       <div class="vertical-center">
                        <div class="card-block">
                          <h4 class="card-title">Monthly Retreat</h4>
