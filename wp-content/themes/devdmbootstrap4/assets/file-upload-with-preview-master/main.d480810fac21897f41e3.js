elementExists = document.getElementById("custom-file-container-image");
if (typeof(elementExists) != 'undefined' && elementExists != null)
{
  ...
  !(function(A) {
    ...
    (C.m = A),
      (C.c = B),
      (C.d = function(A, e, g) {
        C.o(A, e) || Object.defineProperty(A, e, { enumerable: !0, get: g });
      }),
      (C.r = function(A) {
    ...
    function(A, e, g) {
      ...
      var B = g(0),
            ...
            function A(e, g) {
              ...
              if (
                ...
                (this.options.text.selectedCount = this.options.text.hasOwnProperty(
                  ...
                  : "files selected"),
                (this.options.maxFileCount = this.options.hasOwnProperty(
                  "maxFileCount"
                )
                  ...
                  value: function(A) {
                    if (0 !== A.length) {
                      ...
                      this.options.maxFileCount > 0 &&
                        A.length + this.cachedFileArray.length >
                          this.options.maxFileCount &&
                        (e =
                          this.options.maxFileCount -
        ...
        a = g(9),
        s = new o("myFirstImage");
      document
        .querySelector(".upload-info-button--first")
        .addEventListener("click", function() {
          console.log("First upload:", s, s.cachedFileArray);
        });
      
   
        window.addEventListener("fileUploadWithPreview:imagesAdded", function(A) {
          "myFirstImage" === A.detail.uploadId &&
            (console.log(A.detail.addedFilesCount),
            console.log(A.detail.cachedFileArray))
        })
    }
  ]);
